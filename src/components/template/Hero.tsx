...
export default function Hero() {
    ...
    return (
        ...
        <div className="hero-content text-center text-gray-500">
            ...
            <p className="mb-5 py-6 text-3xl">...com respeito aos seres, integração com a natureza e decisões consentidas, para um vida plena, feliz e onde a evolução das potencialidades do ser humano é incentivada.</p>
